 ...
 *   <li><b>useSetImmediate</b></li> - if set to false, use process.nextTick instead of setImmediate. defaults to true
 * </ul>
 *
 * @constructor
...
function MailParser(options) {
    ...
    /**
     *  Default value for useSetImmediate: true
     */
    this.options.useSetImmediate = (typeof this.options.useSetImmediate === "boolean") ? this.options.useSetImmediate : true;
...
MailParser.prototype.write = function(chunk, encoding) {
    if (this._write(chunk, encoding)) {
        if (typeof setImmediate == "function" && this.options.useSetImmediate) {
